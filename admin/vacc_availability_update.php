                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                $Id= $_GET['id'];
                                                $sql = "select * from vaccine_availability where id = $Id";
                                                $result = mysqli_query($conn,$sql);
                                                $rows = mysqli_fetch_assoc($result);

                                                ?>
                                                <input type="text" name="status" value="<?php echo $rows['Status'] ?>" class="form-control" placeholder="Enter Status">
                                            </div>

                                            <div class="form-group col-md-12">
                                                <label>Hospital</label>
                                                <input type="text" name="hospital" value="<?php echo $rows['Hospital'] ?>" class="form-control" placeholder="Enter Hospital Name">
                                            </div>
...
if(isset($_POST['submit'])){
    ...
    $sql = "update vaccine_availability set USER_ID_FK = '$user', VACCINE_ID_FK = '$vaccine', Status = '$status', Hospital = '$hospital' where id = $Id";
    $result = mysqli_query($conn,$sql);
